...
;!function(win){
  ...
  ,modules = {
    ...
    ,ztree: 'modules/ztree' // zTree（第三方）
    ,ztreeedit: 'modules/ztree.exedit' // ztree编辑
	,ztreecheck: 'modules/ztree.excheck' // ztree选择
    ,nprogress: 'modules/nprogress' // 进度条
    ,echoform: 'modules/echoform' // form回显
