 ...
 * File Name:RefundRecordParams.java
 * Package Name:com.meatball.api.ykt.parems
 * Date:2018年3月13日下午4:06:23
...
/**   
 * @Title: RefundRecordParams.java 
 * @Package com.meatball.api.ykt.parems 
 * @Description: TODO(退款记录信息) 
 * @author jw 
 * @date 2018年3月13日 下午4:06:23 
 * @version V1.0   
 */
public class RefundRecordParams implements Serializable {
	...
	@ApiModelProperty(value="退款状态(0成功 1失败 )", example="0")
    private Integer iDealstatus;
	
	@ApiModelProperty(value="退款方式(1现金2银行卡3微信4支付宝5余额)", example="1")
    private Integer iPaytype;
    
	@ApiModelProperty(value="退款方式名称", example="现金")
    private String vPayname;
	
	@ApiModelProperty(value="退款支付编号(平台交易流水号)", example="11111111")
	...
	@ApiModelProperty(value="退款金额(带两位小数点)", example="5000.00")
    private String dBalance;
   
	@ApiModelProperty(value="退款时间(yyyy-MM-dd HH:mm:ss)", example="2010-10-10 15:11:12")
	...
	@ApiModelProperty(value="身份证照片路径", example="xxxx")
    private String vPic;
