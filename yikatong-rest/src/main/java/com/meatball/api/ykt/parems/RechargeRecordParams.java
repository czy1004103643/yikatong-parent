 ...
 * File Name:RechargeRecordParams.java
 * Package Name:com.meatball.api.ykt.parems
 * Date:2018年3月13日下午4:03:47
...
/**   
 * @Title: RechargeRecordParams.java 
 * @Package com.meatball.api.ykt.parems 
 * @Description: TODO(充值记录信息) 
 * @author jw 
 * @date 2018年3月13日 下午4:03:47 
 * @version V1.0   
 */
public class RechargeRecordParams implements Serializable {
	...
	@ApiModelProperty(value="支付方式(1现金2银行卡3微信4支付宝)", example="1")
    private Integer iPaytype;

	@ApiModelProperty(value="支付方式名称", example="现金")
    private String vPayname;
	
	@ApiModelProperty(value="充值支付编号(平台交易流水号)", example="11111111")
	...
	@ApiModelProperty(value="充值金额(带两位小数点)", example="5000.00")
    private String dBalance;
     
	@ApiModelProperty(value="充值状态(0成功 1失败 8撤销 9待支付)", example="0")
    private Integer iDealstatus;
    
	@ApiModelProperty(value="充值时间(yyyy-MM-dd HH:mm:ss)", example="2010-10-10 15:11:12")
